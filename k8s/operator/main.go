...
import (
	...
	"github.com/nithinpasula/clever-sloth-operator/internal/controller"
)
...
func main() {
	...
	if err = (&controller.CleverSlothProjectReconciler{
	...
	setupLog.Info("starting clever-sloth-operator")
